...
export default function MaleCollectionPage() {
  const [filteredProducts, setFilteredProducts] = useState(maleProducts)
  const [priceRange, setPriceRange] = useState([0, 3000])
  const [selectedCategory, setSelectedCategory] = useState("all")
  const [sortBy, setSortBy] = useState("featured")
  const [searchQuery, setSearchQuery] = useState("")

  const categories = ["all", "rings", "necklaces", "bracelets", "watches", "cufflinks"]

  const handleFilter = () => {
    let filtered = maleProducts
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white">
      <div className="container-responsive py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-responsive text-gray-600">Sophisticated and stylish jewelry designed for men</p>
        </div>
          ...
          <div className="lg:w-1/4">
            <Card className="p-6 border-pink-100 bg-white/80 backdrop-blur-sm">
              ...
              <div className="mb-6">
                ...
                <Slider value={priceRange} onValueChange={setPriceRange} max={3000} step={100} className="mt-2" />
              </div>
          ...
          <div className="lg:w-3/4">
            <div className="flex justify-between items-center mb-6">
              <p className="text-gray-600">
                Showing {filteredProducts.length} of {maleProducts.length} products
              </p>
            </div>
